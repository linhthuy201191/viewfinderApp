...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Basic WebView setup needed for a modern, interactive website.
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                // Keep navigation inside the app for our own site;
                // let the system handle anything external (mail, other apps, etc.)
                if (host != null && host.equalsIgnoreCase(ALLOWED_HOST)) {
                    return false; // load in this WebView
                }
                return true; // hand off to the OS / browser
            }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        // Let the phone's back button navigate WebView history first.
